...
{
public:
	static Texture2D* Get(std::string path);  // stringで受け取ったパスからテクスチャの読み込み
	static Texture2D* Get(std::wstring path); // wstringで受け取ったパスからテクスチャの読み込み
	static Texture2D* GetWhite();             // 白の単色テクスチャを生成
